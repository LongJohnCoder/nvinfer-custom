...
gst_nvinfer_parse_class_attrs (GKeyFile * key_file, gchar * group,
    ...
    GstNvinfercustomDetectionFilterParams & detection_filter_params,
...
static gboolean
gst_nvinfer_parse_other_attribute (GstNvinfercustom * nvinfer,
...
static gboolean
gst_nvinfer_parse_props (GstNvinfercustom * nvinfer,
    ...
    const gchar * cfg_file_path)
{
  ...
  if (init_params->networkType == NvDsInferNetworkType_Detector) {
    ...
    GstNvinfercustomDetectionFilterParams detection_filter_params{0, 0, 0, 0, 0, 0};
    GstNvinfercustomColorParams color_params;
    ...
    nvinfer->perClassDetectionFilterParams =
        new std::vector < GstNvinfercustomDetectionFilterParams >
        (init_params->numDetectedClasses, detection_filter_params);
    nvinfer->perClassColorParams =
        new std::vector < GstNvinfercustomColorParams >
